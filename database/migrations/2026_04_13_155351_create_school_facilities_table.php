...
return new class extends Migration {
    ...
    {
        Schema::create('school_facilities', function (Blueprint $table): void {
            $table->id();
            ...
            $table->unsignedInteger('usable_quantity')->default(0);
            ...
            $table->unique(
                ['school_id', 'facility_type_id', 'academic_session_id'],
                'school_facilities_school_type_session_unique'
            );
        });
    }
